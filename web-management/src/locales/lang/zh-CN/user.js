export default {
  ...
  'user.login.username.placeholder': '请输入手机号码',//基础用户名：admin
  'user.login.password.placeholder': '请输入密码',//基础密码：admin
  'user.login.message-invalid-credentials': '账户或密码错误（admin/ant.design）',
  'user.login.message-invalid-verification-code': '验证码错误',
  'user.login.tab-login-credentials': '手机密码登录',
  ...
  'user.login.login': '登录',
  'user.login.recover.next': '下一步',
  'user.register.register': '注册',
  'user.register.new-password': '确认重置',

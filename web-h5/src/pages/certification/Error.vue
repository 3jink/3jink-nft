<template>
<view class="content">
<!--  <uni-nav-bar title="认证失败"/>-->
  <view class="circle" >
    <image src="@/static/img/error.svg" class="w-d-210"/>
  </view>
  <view class='ta-c fs-58'>认证失败，请重新认证</view>
  <u-button text="确定" class="w-670 fs-40" color="#28AE5F" @click="navigatorTo"></u-button>
</view>
</template>
